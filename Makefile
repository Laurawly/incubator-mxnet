...
# ver2
#ifeq ($(USE_OPENCV), 1)
# CFLAGS += -DMXNET_USE_OPENCV=1 -I/home/vsk/src/opencv-build/include
# LDFLAGS += -L/home/vsk/src/opencv-build/lib $(filter-out -lopencv, $(shell pkg-config --libs opencv)) 
# BIN += bin/im2rec
#else
# CFLAGS+= -DMXNET_USE_OPENCV=0
#endif
...
#ver3
#ifeq ($(USE_OPENCV), 1)
# CFLAGS += -DMXNET_USE_OPENCV=1 -I/home/vsk/src/opencv-build/include/ $(shell pkg-config --cflags opencv)
# LDFLAGS += -lopencv_imgcodecs -L/home/vsk/src/opencv-build/lib $(filter-out -lopencv_ts, $(shell pkg-config --libs opencv))
# BIN += bin/im2rec
#else
# CFLAGS+= -DMXNET_USE_OPENCV=0
#endif
...
ifeq ($(USE_OPENCV), 1)
 CFLAGS += -DMXNET_USE_OPENCV=1 -I/home/vsk/src/opencv-build/include/ 
 LDFLAGS += -L/home/vsk/src/opencv-build/lib -lopencv_imgcodecs -lopencv_imgproc -lopencv_core
 BIN += bin/im2rec
else
 CFLAGS+= -DMXNET_USE_OPENCV=0
endif
export PKG_CONFIG_PATH=$PKG_CONFIG_PATH:/home/wanleyua/opencv-build/lib/pkgconfig/
